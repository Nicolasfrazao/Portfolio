...
const AboutMeCard = () => {
  return (
    <div className="backdrop-blur-lg dark:bg-gradient-to-r from-slate-900/20 to-gray-700/20 bg-opacity-75  rounded-2xl min-h-96 p-6 mt-10 flex items-start shadow-2xl shadow-slate-800 dark:shadow-gray-600">
      ...
      <div>
        ...
        <p className="mb-4">
          &nbsp;Beyond my technical skills, I bring a strategic business mindset
          ...
          reach new heights. With over 150 certifications across diverse fields
        ...
        <p>
          &nbsp;In addition to my technical accomplishments, I&apos;m an avid
          athlete, which has ingrained in me a strong work ethic, discipline,
          and an unbreakable drive to excel. Whether I&apos;m coding, leading a team,
          team, or exploring new ventures, I approach every endeavor with a
          commitment to surpassing expectations and making a meaningful impact.
        </p>
      </div>
    </div>
  );
